...
Lurny šobrīd ir **klientu puses** aplikācija – tai nav serveru, nav kontu un nav mākoņa. Visi tavi dati dzīvo tavā tīmeklī.

Šī funkcionalitāte var tikt mainīta; lietotāju konti un to pārvaldība tiks iekļauti **nākotnes atjauninājumos.**

---

## Kā dati plūst:

Katra jūsu veiktā darbība - kavas izveide, kāršu izpēte, progresa izsekošana - tiek saglabāta un nolasīta jūsu pārlūkprogrammas lokālajā krātuvē. Nekas nekad netiek nosūtīts uz serveri.
...
Lurnly izmanto divas dažādas atslēgas lokālajā krātuvē.
...
Katra kava tiek saglabāta kā .JSON objekts. Šeit ir kā 1.3. versijas kavas izskatās.
...
Lurnly lasa gan tagadnes, gan pagātnes formātus, lai kavas no iepriekšējām versijām tiktu importētas bez problēmām.
...
Importējot kāršu komplektu bez `id` lauka, Lurnly automātiski ģenerē tādu, izmantojot pašreizējo laika zīmogu.

```
deck_1714000000000_0
```

Tas nodrošina, ka katru komplektu var unikāli identificēt izpētei, rediģēšanai un dzēšanai — pat ja sākotnējais eksports ir datēts pirms ID sistēmas.
