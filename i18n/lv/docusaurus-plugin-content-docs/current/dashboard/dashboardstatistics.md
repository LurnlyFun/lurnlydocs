---
description: Mācīšanās statistika un izsekošana
sidebar_position: 2
---

# 📊 Mācīšanās statistika un izsekošana
**Vadības panelis uzrauga jūsu aktivitāti, lai palīdzētu jums palikt konsekventi ar mācīšanās mērķiem.**

---

## Dienu sērija:
Izseko konsekventās mācīšanās dienas, izmantojot dinamisku emocijzīmju sistēmu (🔥 sākumam, 🌟 par 7 dienām, ⚡ par 14 dienām un 👑 par 30+ dienām).


<div style={{display: 'flex', flexDirection: 'column', gap: '14px', maxWidth: '440px'}}>

  <div style={{background: 'linear-gradient(135deg, #fff5fd 0%, #ffeef9 100%)', border: '2px solid #ffd4f4', borderRadius: '20px', padding: '18px 20px', boxShadow: '0 4px 20px rgba(140, 82, 255, 0.12)'}}>
    <div style={{display: 'flex', alignItems: 'center', gap: '16px'}}>
      <div style={{width: '62px', height: '62px', flexShrink: 0, background: 'linear-gradient(135deg, #ff6b35 0%, #f7931e 100%)', borderRadius: '18px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 15px rgba(255, 107, 53, 0.4)'}}>
...
## Kopējie komplekti un kartes:
Parāda jūsu lokālās mācīšanās bibliotēkas kopējo apjomu.
...
## Šodien mācīts:
Parāda, cik kartes esat pabeidzis pašreizējā 24 stundu periodā.
...
## Vidējais progress:
Aprēķina vidējo pabeigšanas procentu visos jūsu komplektos.
