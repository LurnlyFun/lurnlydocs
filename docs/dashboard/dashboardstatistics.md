---
description: Learning Statistics & Tracking
sidebar_position: 2
---

# 📊 Learning Statistics & Tracking
**The dashboard monitors your activity to help you stay consistent with your learning goals.**

---

## Day Streak: 
Tracks consecutive days of study using a dynamic emoji system (🔥 for starts, 🌟 for 7 days, ⚡ for 14 days, and 👑 for 30+ days).
...
## Total Decks & Cards: 
Displays the total volume of your local learning library.
...
## Studied Today: 
Shows how many cards you have completed in the current 24-hour period.
...
## Avg Progress: 
Calculates the average completion percentage across all your decks.
